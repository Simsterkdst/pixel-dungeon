...
public class Badges {
	...
	public static enum Badge {
		MONSTERS_SLAIN_1( "10 Gegner getötet", 0 ),
		MONSTERS_SLAIN_2( "50 Gegner getötet", 1 ),
		MONSTERS_SLAIN_3( "150 Gegner getötet", 2 ),
		MONSTERS_SLAIN_4( "250 Gegner getötet", 3 ),
		GOLD_COLLECTED_1( "100 Gold gesammelt", 4 ),
		GOLD_COLLECTED_2( "500 Gold gesammel", 5 ),
		GOLD_COLLECTED_3( "2500 Gold gesammel", 6 ),
		GOLD_COLLECTED_4( "7500 Gold gesammel", 7 ),
		LEVEL_REACHED_1( "Level 6 erreicht", 8 ),
		LEVEL_REACHED_2( "Level 12 erreicht", 9 ),
		LEVEL_REACHED_3( "Level 18 erreicht", 10 ),
		LEVEL_REACHED_4( "Level 24 erreicht", 11 ),
		ALL_POTIONS_IDENTIFIED( "Alle Tränke identifiziert", 16 ),
		ALL_SCROLLS_IDENTIFIED( "Alle Schriftrollen identifiziert", 17 ),
		ALL_RINGS_IDENTIFIED( "Alle Ringe identifiziert", 18 ),
		ALL_WANDS_IDENTIFIED( "Alle Zauberstäbe identifiziert", 19 ),
		ALL_ITEMS_IDENTIFIED( "Alle Tränke, Schriftrollen, Ringe & Zauberstäbe identifiziert", 35, true ),
		BAG_BOUGHT_SEED_POUCH,
		BAG_BOUGHT_SCROLL_HOLDER,
		BAG_BOUGHT_WAND_HOLSTER,
		ALL_BAGS_BOUGHT( "Alle Taschen gekauft", 23 ),
		DEATH_FROM_FIRE( "Gestorben durch Feuer", 24 ),
		DEATH_FROM_POISON( "Gestorben durch Gift", 25 ),
		DEATH_FROM_GAS( "Gestorben durch giftiges Gas", 26 ),
		DEATH_FROM_HUNGER( "Gestorben durch Hunger", 27 ),
		DEATH_FROM_GLYPH( "Gestorben durch eine Verzauberung", 57 ),
		DEATH_FROM_FALLING( "Gestorben durch herunterfallen", 59 ),
		YASD( "Gestorben durch Feuer, Gift, giftiges Gas und Hunger", 34, true ),
		BOSS_SLAIN_1_WARRIOR,
		BOSS_SLAIN_1_MAGE,
		BOSS_SLAIN_1_ROGUE,
		BOSS_SLAIN_1_HUNTRESS,
		BOSS_SLAIN_1( "Ersten Boss getötet", 12 ),
		BOSS_SLAIN_2( "Zweiten Boss getötet", 13 ),
		BOSS_SLAIN_3( "Dritten Boss getötet", 14 ),
		BOSS_SLAIN_4( "Vierten Boss getötet", 15 ),
